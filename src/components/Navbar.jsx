...
const Navbar = ({ stickNavbar, isScroll }) => {
    ...
    return (
        <motion.div className={`flex justify-between fixed z-10 w-full items-center lg:justify-center text-white font-extralight py-5 lg:py-10 ${!isScroll && path === "/" ? "bg-transparent" : "bg-black"}`}>
            <div className="">
                <div className="dropdown">
                <label className="btn btn-ghost swap swap-rotate lg:hidden">
            ...
            <div className="hidden lg:flex">
                <ul className="flex items-center gap-10 text-lg px-1">
